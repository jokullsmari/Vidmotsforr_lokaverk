...
threeRenderer.setSize(window.innerWidth / 2, window.innerHeight); // Adjust size as needed
document.getElementById('threeCanvas').appendChild(threeRenderer.domElement);
